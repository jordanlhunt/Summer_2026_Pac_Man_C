...
Fast-forward today I'm a 35 year old man going back to school to get computer science degree in the age of generative AI with hopes to get a job in the rapidly crumbling industry of video games. So after taking Computer Architecture in Spring and seeing C++ in action with a really great professor I decided I needed a summer project. I wanted to pick something that was straight fundamentals.

### My Programming Background

I actually have a previous Bachelor's degree in "Information Studies" on my first attempt at university. I genuinely cannot tell you what I learned in that degree program as I don't even know what it means. I essentially failed out of computer science my first time and very nice advisor helped me scrape my credits together and bundle together to a degree so I could graduate in a timely fashion. I did a little bit of Python and Java in school but nothing large than program that did some I/O and a for loop or two.

I even managed to get a job after graduation and worked at a MEGACORP for a bit. I didn't really do much programming there either, it was a bit of JavaScript my first year and a bit of SQL and some proprietary software before I quit because I wasn't going anywhere or doing anything and most importantly I was miserable.

All of my game programming came from a couple of E-books on XNA/Monogame. When I first tried to learn game development it was "XNA" which later became the "[Monogame](https://monogame.net/)" that you see today. I originally picked books on Monogame because I learned that Bastion was written in Monogame. I would later play "Salt & Sanctuary" another excellent game also written in XNA. The XNA/Monogame books were are quite good and I'd highly recommend anyone interested in learning game development pick up Monogame. It's really beginner-friendly and the online community is really nice.
...
I read just about magazine article (remember when those were a thing?), [every blog](https://makegames.tumblr.com/post/1136623767/finishing-a-game), and watched every developer interview on "how to be an indie developer" and all of them said "just make games". The "just" part for me was my biggest issue, I couldn't seem to "just" do something. My problem was I never really took that to heart because I never really believed I could do anything.
...
I recently read "Master's Of Doom" book and it was a really good history lesson on nature of game development. I was really impressed that DOOM was written in C, and always was a bit scared of C. My Computer Architecture course had us write in C and C++ and it was really refreshing. John Romero also mentions really liking PAC-MAN in his "DOOM Guy" autobiography so I chose the arcade classic of yesteryear.

I had done some C and C++ tutorials in previous ventures so I thought it would be an good reason to restart where I originally began. I did some of the LazyFoo SDL2 tutorials in the past but again nothing outside the tutorial guidelines. I also wanted to do something in the "old-school" sense and just to start from zero. I want to choose not to use generative AI software or tools for this project as well.

I wanted to focus on learning and I'm of the belief that learning comes from the mistakes you make and the struggle of trying to figure something out. Which is the least glamorous part of learning and the part I think most everything online seems to skip over.
...
## The Actual Code and Software Development
