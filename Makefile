...
OBJS = src/main.c src/core/audio.c src/core/entity.c src/core/gamecontext.c src/core/gamestate.c src/core/graphics.c src/core/input.c src/core/leveldata.c src/core/player.c
